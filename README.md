...
This is the Theta app. It doesnt try to replicate all the functionality of the website but on ones that are most commonly used. 
...
- [ ] [Set up project integrations](https://gitlab.com/esrtheta/nativeapp/-/settings/integrations)
